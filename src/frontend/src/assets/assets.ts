...
export const features = [
  {
    ...
    description: "Hàng hóa được giao trong vòng 1h",
  },
  {
    icon: leaf_icon,
    title: "Đảm bảo độ tươi ngon",
    description: "Sản phẩm tươi sống trực tiếp từ địa phương",
  },
  {
    icon: coin_icon,
    title: "Giá cả hợp lý",
    description: "Chất lượng với giá cả cạnh tranh nhất",
  },
  {
    icon: trust_icon,
    title: "Được hàng ngàn người tin tưởng",
    description: "Được các khách hàng yêu thích và hài lòng",
  },
];
